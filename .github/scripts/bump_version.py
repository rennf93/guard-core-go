"""
Version bump helper script for guard-core-go.

guard-core-go is a Go module: there is no version file to update, the git
...
def main() -> int:
    ...
    print(
        "  Note: guard-core-go has no version file; the git tag is the version.\n"
